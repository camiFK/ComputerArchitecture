...
Main
    ...
    movlw	b'00000100'	; configura los bits RA7-RA0 del puerto A
    movwf	TRISA		; 
...
reiniciar	
	CLRF	contador
iterar  	
	MOVFF	numero, PORTB			; Movemos el resultado que está en W al PORTB
	btfss	PORTA,2	    ; Mientras no presione el pulsador
